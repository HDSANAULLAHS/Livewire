package com.livewire.audax.gigya
...
*/
    ...
    private fun callGigya(method: Method, params: Map<String, Any>, success: (GigyaApiResponse) -> Unit,
                          failure: (Int) -> Unit) {
        println(method)
        println(RestAdapter.GET)
        println(params )
    ...
    private fun extractUserFromResponse(response: GigyaApiResponse): User {
        ...
        sharedPreference.save("fullName", profile?.firstName+" "+profile?.lastName)
